    ...
    <body>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">Approved Bursary</div>
						<button class="btn btn-danger" onclick="window.print()" style="float:right">Print</button>
                    </div>
...
{               ?>  
                                        <tr>
                                            <td> <b><?php echo htmlentities($cnt);?></b></td>
                                              <td><a href="editestudent.php?empid=<?php echo htmlentities($result->id);?>" target="_blank">
                                            ...
                                            <td>
											<?php if($result->application_status==2)
 {?>
